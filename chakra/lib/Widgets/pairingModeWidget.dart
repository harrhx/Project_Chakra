...
class PairingModeWidget extends StatefulWidget {
  const PairingModeWidget({Key? key}) : super(key: key);

  @override
  _PairingModeWidgetState createState() => _PairingModeWidgetState();
}

class _PairingModeWidgetState extends State<PairingModeWidget>
